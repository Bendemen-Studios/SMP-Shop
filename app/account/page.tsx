...
export default function Account(){
 ...
 const connect=async()=>{setError('');if(!window.Tip4Serv?.OAuth?.Connect){setError('De accountverbinding is nog niet geladen.');return}try{await window.Tip4Serv.OAuth.Connect({return_url:`${location.origin}/account`,store_id:store||undefined});}catch(e){setError(e instanceof Error?e.message:'Inloggen mislukt.')}};
