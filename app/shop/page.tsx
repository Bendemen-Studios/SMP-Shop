...
export default function Shop(){
 ...
 return <main><Header/><div className="shop-page"><span className="eyebrow">DE MARKTPLAATS VAN DE SMP</span><h1 className="shop-title">De <em>Werkplaats</em></h1><p className="shop-intro">Ontdek machines, upgrades, ranks, cosmetics en exclusieve items. Alles wordt live uit Tip4Serv geladen.</p>
  ...
  <div className="workshop-note"><span>⚙</span><div><b>LIVE VERBONDEN MET TIP4SERV</b><p>Prijzen, voorraad, categorieën en productafbeeldingen komen rechtstreeks uit jouw Tip4Serv-store.</p></div></div>
 </div></main>
}