...
export default function Shop(){
 ...
 return <main><Header/><div className="shop-page"><span className="eyebrow">HET EMPORIUM</span><h1 className="shop-title"><em>Het Emporium</em></h1><p className="shop-intro">Ontdek speciale upgrades voor je beleving van deze server. Aankopen in het Emporium is 100% optioneel en is non-refundable</p>
